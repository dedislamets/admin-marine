<ul id="sidebar-menu">
    ...
    <li>
        <a href="{{ url('/home') }}" title="Admin Dashboard">
    ...
    <li class="no-menu">
        <a href="{{ url('/slide') }}" title="">
            <i class="glyph-icon icon-linecons-beaker"></i>
            <span>Slider</span>   
        </a>
    </li>
    <li class="no-menu">
        <a href="{{ url('/profil') }}" title="Company Profile">
            <i class="glyph-icon icon-linecons-doc"></i>
            <span>Company Profile</span>   
        </a>
    </li>
    <li class="header"><span>Master</span></li>
    <li class="no-menu">
        <a href="{{ url('/users') }}" title="Users Register">
            <i class="glyph-icon icon-linecons-eye"></i>
    ...
    <li class="no-menu">
        <a href="{{ url('/pengajuan') }}" title="Frontend template">
            <i class="glyph-icon icon-linecons-wallet"></i>
            <span>Pengajuan</span>   
        </a>
    </li>
